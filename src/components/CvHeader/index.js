...
const CvHeader = ({ data }) => (
  <header className={style.cv}>
    <div className={style.row}>
      <div className={style.cv__header__column1}>
        <Image
          aspectRatio={data.childImageSharp.aspectRatio}
      ...
      <div className={style.cv__header__column2}>
        ...
        <p className={style.cv__header__summary}>
          System och webbutvecklare med drygt 20-års kommersiell erfarenhet från
          utveckling av webb och företagslösningar. Specialiserad på välkända
          opensource teknologier som Linux, Apache/Nginx, PHP, MySQL,
